...
//NOTE: if the user enter an invalid email and password or username
class  Register extends React.Component {
    ...
    onSubmitSignin = () => {
        ...
        fetch('https://mybackend-uuhs.onrender.com/register', {
            method: 'POST',
            headers: {
        ...
        .then(user => {
            if (user.id) {
                //dapat gawa ka muna ng loadUser function sa App.js para ma 'this.props' mo dito sa register
